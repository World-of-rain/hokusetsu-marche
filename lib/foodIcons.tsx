...
const KEYWORD_RULES: [string[], IconKey][] = [
  ...
  [["ひき肉", "ミンチ", "挽肉", "肉"], "beef"],
  [
    ["鮭", "サーモン", "刺身", "まぐろ", "マグロ", "ぶり", "さば", "あじ", "魚", "切身", "干物"],
    "fish",
  ],
  [
    ["えび", "エビ", "海老", "いか", "イカ", "たこ", "タコ", "貝", "ホタテ", "かに", "カニ"],
    "shrimp",
  ],
  [
    [
  ...
  [
    ["りんご", "リンゴ", "みかん", "ぶどう", "いちご", "梨", "もも", "果物", "フルーツ", "柑橘"],
    "apple",
  ],
  [["バナナ"], "banana"],
  [["トイレットペーパー", "ティッシュ", "ペーパー", "キッチンペーパー"], "paper"],
  [
    ["洗剤", "柔軟剤", "漂白", "石けん", "石鹸", "シャンプー", "ボディ", "ハンドソープ"],
    "detergent",
  ],
  ...
  [
    ["アイス", "ケーキ", "プリン", "チョコ", "菓子", "スイーツ", "デザート", "ゼリー", "クッキー"],
    "sweets",
  ],
  [["冷凍", "アイスクリーム"], "frozen"],
];
...
const ICONS: Record<IconKey, ReactNode> = {
  egg: (
    <>
      ...
      <path
        d="M18 16c3-5 9-5 12 0 2 4 0 9-6 9s-8-5-6-9z"
        fill="#fffdf7"
        stroke="#f1e7cf"
        strokeWidth="1.2"
      />
  ...
  milk: (
    <>
      <path
        d="M17 18h14v20a3 3 0 0 1-3 3H20a3 3 0 0 1-3-3z"
        fill="#eaf2ff"
        stroke="#9cc2f5"
        strokeWidth="1.4"
      />
  ...
  bread: (
    <>
      <path
        d="M12 22c0-5 5-8 12-8s12 3 12 8v13a2 2 0 0 1-2 2H14a2 2 0 0 1-2-2z"
        fill="#e8b982"
        stroke="#c68a4e"
        strokeWidth="1.3"
      />
  ...
  rice: (
    <>
      <path
        d="M10 26h28c-1 8-7 12-14 12s-13-4-14-12z"
        fill="#ffffff"
        stroke="#cbd5e1"
        strokeWidth="1.4"
      />
      <path
        d="M14 22c3-3 6 0 10-2 3 2 7-1 10 2"
        fill="none"
        stroke="#e2e8f0"
        strokeWidth="2"
        strokeLinecap="round"
  ...
  noodle: (
    <>
      <path
        d="M11 24h26c-1 9-7 14-13 14s-12-5-13-14z"
        fill="#fde9c8"
        stroke="#e0a458"
        strokeWidth="1.4"
      />
      <path
        d="M15 20c2-4 5 0 9-3 3 3 7-1 9 3"
        fill="none"
        stroke="#eab676"
        strokeWidth="2"
        strokeLinecap="round"
  ...
  beef: (
    <>
      <path
        d="M15 15c8-4 18-1 18 8s-6 12-13 12S9 30 11 22c1-3 2-5 4-7z"
        fill="#f26d6d"
        stroke="#d63d3d"
        strokeWidth="1.4"
      />
  ...
  chicken: (
    <>
      <path
        d="M17 14c6-3 12 2 11 9-1 5-5 7-9 6l-3 5c-1 2-4 2-5 0s0-4 2-5l1-2c-3-3-2-9 2-11z"
        fill="#f0b45a"
        stroke="#d98c2b"
        strokeWidth="1.4"
      />
  ...
  fish: (
    <>
      <path
        d="M8 24c6-8 20-8 26 0-6 8-20 8-26 0z"
        fill="#7dd3fc"
        stroke="#0ea5e9"
        strokeWidth="1.4"
      />
      ...
      <path
        d="M20 20c3 2 3 6 0 8M25 21c2 1.5 2 4.5 0 6"
        fill="none"
        stroke="#38bdf8"
        strokeWidth="1.4"
      />
  ...
  shrimp: (
    <>
      <path
        d="M32 14c-10-2-20 4-20 13 0 5 4 9 10 9 8 0 12-6 11-8-2 2-6 3-9 1 6-1 9-5 9-9"
        fill="#fb923c"
        stroke="#ea6a10"
        strokeWidth="1.4"
      />
      ...
      <path
        d="M18 24c3 1 6 1 9 0M18 29c2 1 5 1 8 0"
        fill="none"
        stroke="#fed7aa"
        strokeWidth="1.3"
      />
  ...
  leafveg: (
    <>
      ...
      <path
        d="M24 11c-6 3-10 9-9 16M24 11c6 3 10 9 9 16M24 12v25"
        fill="none"
        stroke="#4ade80"
        strokeWidth="1.6"
      />
  ...
  tomato: (
    <>
      ...
      <path
        d="M24 14c-4 0-6-2-6-2M24 14c4 0 6-2 6-2M24 14v3"
        fill="none"
        stroke="#3f9142"
        strokeWidth="2"
        strokeLinecap="round"
  ...
  rootveg: (
    <>
      <path
        d="M20 20l8-2 2 4-14 16c-2 2-6-2-4-4z"
        fill="#fb923c"
        stroke="#ea6a10"
        strokeWidth="1.4"
      />
      <path
        d="M28 18l-2-6M30 20l4-4M31 23l6-1"
        fill="none"
        stroke="#4ade80"
        strokeWidth="2"
        strokeLinecap="round"
  ...
  apple: (
    <>
      <path
        d="M24 18c-3-3-11-2-11 7 0 8 6 13 11 13s11-5 11-13c0-9-8-10-11-7z"
        fill="#f43f5e"
        stroke="#be123c"
        strokeWidth="1.4"
      />
      <path
        d="M24 18v-3c0-3 3-4 5-4"
        fill="none"
        stroke="#7c3f16"
        strokeWidth="2"
        strokeLinecap="round"
  ...
  banana: (
    <>
      <path
        d="M13 16c1 12 9 20 21 19 2 0 3-3 1-4-9 0-16-6-17-16 0-2-5-1-5 1z"
        fill="#facc15"
        stroke="#ca8a04"
        strokeWidth="1.4"
      />
  ...
  baby: (
    <>
      <path
        d="M17 17h14l3 6-3 4v9a2 2 0 0 1-2 2H19a2 2 0 0 1-2-2v-9l-3-4z"
        fill="#fbcfe8"
        stroke="#ec4899"
        strokeWidth="1.3"
      />
  ...
  curry: (
    <>
      <path
        d="M9 26h30c-1 8-7 12-15 12S10 34 9 26z"
        fill="#d97706"
        stroke="#b45309"
        strokeWidth="1.4"
      />
  ...
  drink: (
    <>
      <path
        d="M16 16h14v20a3 3 0 0 1-3 3H19a3 3 0 0 1-3-3z"
        fill="#fde68a"
        stroke="#d97706"
        strokeWidth="1.4"
      />
      ...
      <path
        d="M30 21h4a3 3 0 0 1 3 3v3a3 3 0 0 1-3 3h-4"
        fill="none"
        stroke="#d97706"
        strokeWidth="1.4"
      />
  ...
  snack: (
    <>
      <path
        d="M18 12h12l-1 4 2 18-3 3H20l-3-3 2-18z"
        fill="#fb923c"
        stroke="#ea6a10"
        strokeWidth="1.3"
      />
  ...
  sweets: (
    <>
      <path
        d="M12 26l12-8 12 8v8a2 2 0 0 1-2 2H14a2 2 0 0 1-2-2z"
        fill="#fbcfe8"
        stroke="#db2777"
        strokeWidth="1.3"
      />
  ...
  frozen: (
    <>
      <path
        d="M24 9v30M11 16l26 16M37 16L11 32"
        stroke="#38bdf8"
        strokeWidth="2.2"
        strokeLinecap="round"
      />
  ...
  default: (
    <>
      <path
        d="M14 18h20l-2 18a3 3 0 0 1-3 3H19a3 3 0 0 1-3-3z"
        fill="#fde68a"
        stroke="#d97706"
        strokeWidth="1.4"
      />
